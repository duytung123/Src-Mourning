...
class MourningController extends Controller
{
    ...
    private array $formItems = [
        ...
        "related_employee_no", "related_name", "related_kana", "classification","classification_check", "company", "member1", "member2",
...
//      $input['funeral_date']
    ...
    public function postConfirm(MourningRequest $request)
    {
        ...
        if((int)$input['classification_check'] == 2 && ((int)$input['classification'] == 5 || (int)$input['classification'] == 6)){
            $input['status'] = "2";
        } else {
            $input['status'] = "1";
        }
...
//                    dd($status);
                    return match ((int)$status) {
                        null, 0, 1 => redirect()->action([MourningController::class, 'showEdit']),
                        default => redirect()->action([MourningController::class, 'check']),
                    };
                }
            }
        }
