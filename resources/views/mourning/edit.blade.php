        ...
        {{-- <section class="section card grey lighten-5" id="js_create">
            <div class="card-content">
                ...
                <div class="section">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6">
                            ...
                            <label for="superior_employee_no">職場担当者(上司等)の社員番号<sup><i class="tiny material-icons">lens</i></sup></label>
                        </div>
                ...
                <section class="section center-align">
                    <div class="row">
                        <button type="submit" class="col s12 waves-effect waves-light btn btn-large deep-purple lighten-4 grey-text text-darken-2" role="button">
                            【職場担当者(上司等)】入力内容確認<i class="material-icons right">chevron_right</i></button>
                    </div>
                </section>
            </div>
        </section> --}}
