@extends('layout')
@section('title', '弔事連絡表 新規登録画面 | 丸井グループ 弔事連絡表')
@section('content')
    <div class="row  purple-accent-3"><i class="material-icons purple-accent-3">lens</i> 必須項目</div>
    <form action="{{ route('create.post') }}" method="POST" onSubmit="return" id="related_employee_input" name="related_employee_input">
        @csrf
        ...
        <section class="section card grey lighten-5" id="js_create">
            <div class="card-content">
                ...
                <div class="section">
                    <div class="row">
                      <span class="card-title text-small">入力者<sup><i class="tiny material-icons">lens</i></sup></span>
                      <label class="col">
                    ...
                    <div class="row">
                        <div class="col m12 l6">
                            ...
                            <div class="white">
                                <div class="row">
                                    <span class="card-title text-small">弔事当事者</span>
                                    <div class="input-field col s12 m6">
                                        <input id="related_employee_no" name="related_employee_no" type="text" class="validate zen2half" pattern="[0-9]{7}" maxlength="7" minlength="7" required @if(old('related_employee_no')) value="old('related_employee_no')" @endif @if($session['related_employee_no']) value="{{$session['related_employee_no']}}" @endif placeholder="0000000">
                                    ...
                                    @endif
                                    <div class="input-field col s12 m6">
                                        <input id="membership_year" name="membership_year" type="text" class="validate zen2half" pattern="[0-9]{4}" maxlength="4" minlength="4" @if(old('membership_year')) value="old('membership_year')" @endif @if($session['membership_year']) value="{{$session['membership_year']}}" @endif placeholder="2000" min="1900">
                                        <label for="membership_year">入社年度</label>
                                    </div>
                                    @if ($errors->has('related_employee_no'))
                                        <div class="card section teal lighten-4 col s12">
                                            <div class="inner-block teal-text text-darken-4">
                                ...
                                <div class="row">
                                    <div class="input-field col s12 m6">
                                        <input id="member1" name="member1" type="text" class="validate" required placeholder="店/部/事業所を自由入力" @if(old('member1')) value="old('member1')" @endif @if($session['member1']) value="{{$session['member1']}}" @endif>
                                        <label for="member1">所属①<sup><i class="tiny material-icons">lens</i></sup></label>
                                    </div>
                                    ...
                                    @endif
                                    <div class="input-field col s12 m6">
                                        <input id="member2" name="member2" type="text" class="validate" required placeholder="ｼｮｯﾌﾟ/課/室/担当を自由入力" @if(old('member2')) value="old('member2')" @endif @if($session['member2']) value="{{$session['member2']}}" @endif>
                                        <label for="member2">所属②<sup><i class="tiny material-icons">lens</i></sup></label>
                                    </div>
            ...
            <div class="card-content">
                ...
                <div class="section">
                    ...
                    <div id="js_inlaws" class="grey lighten-3 toggle-body @if(old('inlaws') == '1' || $session['inlaws'] == '1') active @endif">
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="inlaws_employee_no" name="inlaws_employee_no" type="text" class="validate zen2half" pattern="[0-9]{7}" maxlength="7" minlength="7"  @if(old('inlaws_employee_no')) value="old('inlaws_employee_no')" @endif @if($session['inlaws_employee_no']) value="{{$session['inlaws_employee_no']}}" @endif>
                                <label for="inlaws_employee_no">社内親族の社員番号</label>
                            </div>
                        ...
                        {{-- Edit by IVS 2023/12/07 --}}
                        <div class="row">
                            <p class="col s12">福祉会規定分の供花/弔電の手配<sup><i class="tiny material-icons">lens</i></sup></p>
                            <label class="col s12">
                            ...
                            <label class="col s12">
                                ...
                                <span>親族からの手配を優先する</span>
                            </label>
                            <p class="caution_capture">注）会社規定分は、職場が異なる場合、双方から供花・弔電の手配となります。</p>
        ...
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">通夜について</span>
                <div class="divider"></div>
                <div class="section">
                    <div class="row">
                        <label class="col">
        ...
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">告別式について</span>
                <div class="divider"></div>
                <div class="section">
                    <div class="row">
                        <label class="col">
        ...
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">グループネットへの掲載について<sup><i class="tiny material-icons">lens</i></sup></span>
                <div class="divider"></div>
                <div class="section">
                    <div class="row">
                        {{-- <p class="col s12 label">グループネットへの掲載について<sup><i class="tiny material-icons">lens</i></sup></p> --}}
                        </p>
                        <label class="col">
    ...
    <div id="js_wake" class="grey lighten-3 toggle-body @if(old('wake') == '0' || $session['wake'] == '0' || (old('wake') != '1' && $session['wake'] != '1')) active @endif">
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">通夜の場所</span>
                <div class="divider"></div>
                <div class="section">
                        <div class="row">
                            <div class="input-field col s12 m6">
                            ...
                            <div class="input-field col s6 m3">
                                {{-- Edit by IVS 2023/12/07 --}}
                                <input id="wake_time_end" name="wake_time_end" type="time" @if(old('wake_time_end')) value="old('wake_time_end')" @endif @if($session['wake_time_end']) value="{{$session['wake_time_end']}}" @endif>
                                {{-- END edit by IVS 2023/12/07 --}}
                                <label for="wake_time_end">通夜の終了時刻</label>
                            </div>
    ...
    <div id="js_funeral" class="grey lighten-3 toggle-body @if(old('funeral') == '0' || $session['funeral'] == '0' || (old('funeral') != '1' && $session['funeral'] != '1')) active @endif">
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">告別式の場所</span>
                <div class="divider"></div>
                <div class="section">
                    <!-- ▼▼告別式を行う場合の表示▼▼ -->
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="funeral_date" name="funeral_date" type="date" class="validate required" @if(old('funeral_date')) value="old('funeral_date')" @endif @if($session['funeral_date']) value="{{$session['funeral_date']}}" @endif>
                            ...
                            @endif
                            <div class="input-field col s6 m3">
                                <input id="funeral_time_start" name="funeral_time_start" type="time" class="validate required" @if(old('funeral_time_start')) value="old('funeral_time_start')" @endif @if($session['funeral_time_start']) value="{{$session['funeral_time_start']}}" @endif>
                        ...
                        <div class="row">
                            ...
                            <label class="col">
                                <input type="radio" name="funeral_same_ceremony" class="is-toggle" data-tgt="js_funeral_same_ceremony" data-state="false" value="0" class="required" @if(old('funeral_same_ceremony') == '0' || $session['funeral_same_ceremony'] == '0' || (old('funeral_same_ceremony') != '1' && $session['funeral_same_ceremony'] != '1')) checked @endif>
                                <span>通夜と同じ式場</span>
                            </label>
                            <label class="col">
                                <input type="radio" name="funeral_same_ceremony" class="is-toggle" data-tgt="js_funeral_same_ceremony" data-state="true" value="1" @if(old('funeral_same_ceremony') == '1' || $session['funeral_same_ceremony'] == '1') checked @endif>
                                <span>通夜と異なる式場</span>
                            </label>
                        ...
                        <div id="js_funeral_same_ceremony" class="grey lighten-3 toggle-body @if(old('funeral_same_ceremony') == '1' || $session['funeral_same_ceremony'] == '1') active @endif">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="funeral_ceremony" name="funeral_ceremony" type="text" class="validate text-small required" @if(old('funeral_ceremony')) value="old('funeral_ceremony')" @endif @if($session['funeral_ceremony']) value="{{$session['funeral_ceremony']}}" @endif>
                                ...
                                @endif
                                <div class="input-field col s12 m6">
                                    <input id="funeral_ceremony_zip" name="funeral_ceremony_zip" type="text" class="validate zen2half zip required" pattern="[0-9]{3}[-−ー]?[0-9]{4}" minlength="7" maxlength="8" onfocusout="AjaxZip3.zip2addr(this,'','funeral_ceremony_addr1','funeral_ceremony_addr1');" @if(old('funeral_ceremony_zip')) value="old('funeral_ceremony_zip')" @endif @if($session['funeral_ceremony_zip']) value="{{$session['funeral_ceremony_zip']}}" @endif>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="funeral_ceremony_addr1" name="funeral_ceremony_addr1" type="text" class="validate text-small required" @if(old('funeral_ceremony_addr1')) value="old('funeral_ceremony_addr1')" @endif @if($session['funeral_ceremony_addr1']) value="{{$session['funeral_ceremony_addr1']}}" @endif>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="funeral_ceremony_addr2" name="funeral_ceremony_addr2" type="text" class="validate text-small required" @if(old('funeral_ceremony_addr2')) value="old('funeral_ceremony_addr2')" @endif @if($session['funeral_ceremony_addr2']) value="{{$session['funeral_ceremony_addr2']}}" @endif>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="funeral_ceremony_tel" name="funeral_ceremony_tel" type="text" class="validate zen2half required" pattern="[0-9\-−ー\+＋ 　]+" @if(old('funeral_ceremony_tel')) value="old('funeral_ceremony_tel')" @endif @if($session['funeral_ceremony_tel']) value="{{$session['funeral_ceremony_tel']}}" @endif>
        ...
        <section class="section card grey lighten-5">
            <div class="card-content">
                <span class="card-title">喪主について</span>
                <div class="divider"></div>
                <div class="section">
                    <div class="row">
        ...
        <section class="section center-align">
            <div class="">
                <button type="submit" class="waves-effect waves-light btn btn-large deep-purple lighten-4 grey-text text-darken-2" role="button">入力内容確認<i class="material-icons right">chevron_right</i></button>
            </div>
        </section>
    </form>
@endsection
