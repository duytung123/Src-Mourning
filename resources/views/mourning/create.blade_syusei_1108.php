                        ...
                        <div class="col m12 l6">
                            ...
                            <div class="white">
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="input-field col s12 m6">
                                        <input id="membership_year" name="membership_year" type="text" class="validate zen2half" pattern="[0-9]{4}" maxlength="4" minlength="4" required @if(old('membership_year')) value="old('membership_year')" @endif @if($session['membership_year']) value="{{$session['membership_year']}}" @endif placeholder="2000" min="1900">
                                ...
                                <div class="row" id="js_classification_check" style="display: none">
                                    ...
                                    <label class="col">
                                        <input type="radio" name="classification_check" class="required" value="1" @if (old('classification_check') == '1' || (int)$session['classification_check'] == '1') checked @endif>
                                        <span>必要</span>
                                    </label>
                                    <label class="col">
        ...
        <section class="section card grey lighten-5">
            <div class="card-content">
                ...
                <div class="section">
                    ...
                    <div class="row">
                        <p class="col s12 label">全社FAX / Gネット掲示へ掲載を希望します<sup><i class="tiny material-icons">lens</i></sup></p>
                        </p>
                        <label class="col">
