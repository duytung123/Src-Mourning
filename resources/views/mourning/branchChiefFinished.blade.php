...
@section('content')
    <section class="section card grey lighten-5">
        <div class="card-content">
            <h4 class="center-align">組合役員の登録が完了しました</h4>
    ...
    <section class="section center-align">
        <div class="">
            <a href="{{ route('manager.login') }}" class="waves-effect waves-light btn btn-large deep-purple lighten-4 grey-text text-darken-2 w-full" role="button"><i class="material-icons left">home</i>ログイン画面
                                                                                                                                                                                                            に戻る</a>
        </div>
    </section>
@endsection
